                ...
                <td>
                    <div class="container" id="aquaponics">
                        <div class="front aquaponicsFront side">
                            <div class="content">
                                <h2>What is Aquaponics?</h2> <!-- Changed from h1 to h2 -->
                                <h4>Aquaponics is a sustainable farming method that combines aquaculture (fish farming) and hydroponics (growing plants in water) in a symbiotic system. In an aquaponics system, fish waste provides nutrients for the plants, while the plants naturally filter the water for the fish.</h4> <!-- Changed from p to h4 -->
                                <button onclick="flipCardBack('aquaponics')">Read More</button>
                            </div>
                        </div>
                        <div class="back aquaponicsBack side" id="aquaponics">
                            <div class="content">
                                <h4>The fish waste, which contains ammonia, is broken down by beneficial bacteria into nitrates. These nitrates serve as fertilizer for the plants, allowing them to grow without the need for soil. As the plants absorb the nutrients, they purify the water, creating a clean and healthy environment for the fish.

                                    Its advantages are that it requires significantly less water compared to conventional agriculture, as water is recycled within the system and it eliminates the need for chemical fertilizers and pesticides, promoting organic and sustainable food production. </h4> 
                                <button onclick="flipCard('aquaponics')">Read Less</button>
                            </div>
                        </div>
                    </div>
                </td>
