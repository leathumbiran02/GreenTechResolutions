...
void sendCommandToArduino(char command, std::function<void(String)> callback) {
  ...
  // You can call the callback function with the response from Arduino when it becomes available
  String responseFromArduino = "Response from Arduino"; // Replace with actual response
